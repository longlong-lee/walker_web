...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('app', ['ui.router', 'ngResource', 'ngAnimate', 'ngFileUpload', 'cgNotify', 'ui.bootstrap']).config(__webpack_require__(1)).run(__webpack_require__(10)).filter('nameFilter', __webpack_require__(11)).filter('toolFilter', __webpack_require__(12));
...
/***/ function(module, exports) {
	...
	module.exports = ['$scope', '$state', 'notify', '$resource', '$uibModal', function ($scope, $state, notify, $resource, $uibModal) {
...
/***/ function(module, exports) {
	...
	module.exports = ['$scope', '$rootScope', 'notify', '$resource', '$interval', '$uibModal', function ($scope, $rootScope, notify, $resource, $interval, $uibModal) {
...
/***/ function(module, exports) {
	...
	module.exports = ['$scope', '$state', 'Upload', 'notify', '$resource', '$uibModal', function ($scope, $state, Upload, notify, $resource, $uibModal) {
	  //------------------地图模块开始----------------------
...
/***/ function(module, exports) {
	...
	var setting = ['$rootScope', '$state', '$interval', function ($rootScope, $state, $interval) {
