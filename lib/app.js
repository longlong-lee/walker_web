...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('app', ['ui.router', 'ngResource', 'ngAnimate', 'ngFileUpload', 'cgNotify', 'ui.bootstrap']).config(__webpack_require__(1)).filter('nameFilter', __webpack_require__(10)).filter('toolFilter', __webpack_require__(11));
...
/***/ function(module, exports) {
	...
	module.exports = ['$scope', '$state', 'notify', '$resource', '$interval', '$uibModal', function ($scope, $state, notify, $resource, $interval, $uibModal) {
